...
function sentenceE(seed) {
  ...
  return sentences[Math.floor(Math.random() * sentences.length)](seed++) +
    ' because ' + sentences[Math.floor(Math.random() * sentences.length)](10 + seed++);
}
...
function sentenceF(seed) {
  ...
  sentences = [sentenceA, sentenceB, sentenceC, sentenceD];
  return sentences[Math.floor(Math.random() * sentences.length)](seed++) +
    ' when ' + sentences[Math.floor(Math.random() * sentences.length)](10 + seed++);
}
...
function sentenceG(seed) {
  ...
  sentences = [sentenceA, sentenceB, sentenceC, sentenceD];
  return sentences[Math.floor(Math.random() * sentences.length)](seed++) +
    ' though ' + sentences[Math.floor(Math.random() * sentences.length)](10 + seed++);
}
...
function sentenceH(seed) {
  ...
  sentences = [sentenceA, sentenceB, sentenceC, sentenceD];
  return sentences[Math.floor(Math.random() * sentences.length)](seed++) +
    ' while ' + sentences[Math.floor(Math.random() * sentences.length)](10 + seed++);
}
...
function sentenceI(seed) {
  ...
  sentences = [sentenceA, sentenceB, sentenceC, sentenceD];
  return sentences[Math.floor(Math.random() * sentences.length)](seed++) +
    ', and ' + sentences[Math.floor(Math.random() * sentences.length)](10 + seed++);
}
...
function sentenceJ(seed) {
  ...
  sentences = [sentenceA, sentenceB, sentenceC, sentenceD];
  return sentences[Math.floor(Math.random() * sentences.length)](seed++) +
    ', but ' + sentences[Math.floor(Math.random() * sentences.length)](10 + seed++);
}
...
function sentenceK(seed) {
  ...
  sentences = [sentenceA, sentenceB, sentenceC, sentenceD];
  return sentences[Math.floor(Math.random() * sentences.length)](seed++) +
    ', so ' + sentences[Math.floor(Math.random() * sentences.length)](10 + seed++);
}
...
function sentenceL(seed) {
  ...
  sentences = [sentenceA, sentenceB, sentenceC, sentenceD];
  return sentences[Math.floor(Math.random() * sentences.length)](seed++) +
    ', after ' + sentences[Math.floor(Math.random() * sentences.length)](10 + seed++);
}

function sentenceM(seed) {
  sentences = [sentenceA, sentenceB, sentenceC, sentenceD];
  return sentences[Math.floor(Math.random() * sentences.length)](seed++) +
    ', before ' + sentences[Math.floor(Math.random() * sentences.length)](10 + seed++);
}
...
function randomSentence(seed) {
  ...
  sentence = sentences[Math.floor(Math.random() * sentences.length)](seed++);
...
function randomParagraph(seed) {
  ...
  var sentences = 4 + Math.floor(Math.random() * 5);
  var paragraph = [];
...
function randomParagraphs(seed) {
  ...
  var paragraphs = 5 + Math.floor(Math.random() * 100);
  var article = [];
...
function randomLinks(seed, hostname) {
  var linkCount = 5 + Math.floor(Math.random() * 10);
  var links = [];
...
function randomPage(req, res) {
  ...
  res.send({ title, paragraphs, links });
}
